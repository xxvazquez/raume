...
- **Adjective type** — adjective rows carry a small **い-adj** / **な-adj** pill
  next to the meaning (lavender / sage), so the two classes read apart at a
  glance. Tagged across the Adjectives table and Taste & Texture (its mimetic
  words — *mochimochi*, *sakusaku* — are left untagged). It rides along in the
  Meaning column — not a new column — and stays out of search. Driven by an
  `adj` field on the row.
