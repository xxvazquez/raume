...
window.RaumeStudy.flashcards.views = (function () {
  ...
  function renderHelp(panel) {
    panel.innerHTML =
      ...
      '<li><span class="help-term">Style · Script · Words</span><span class="help-desc">Crossword, arroword, word search or Match; romaji, Japanese (with kanji — Match and word search), hiragana words only or katakana words only; and how many words.</span></li>' +
