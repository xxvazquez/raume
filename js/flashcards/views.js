...
window.RaumeStudy.flashcards.views = (function () {
  ...
  function renderHelp(panel) {
    panel.innerHTML =
      ...
      '<ul class="fc-help-list">' +
      '<li><span class="fc-legend-term">Source</span> — <span class="fc-legend-term">Flashcards</span> (added, non-paused words) or <span class="fc-legend-term">A table</span>: one or more vocabulary tables, whether or not they\'re in flashcards. Every answer is the word\'s reading; kanji is never shown or typed. A puzzle always has at least 6 words, and clues that give the answer away (<em>sake</em> for さけ, <em>cola</em> for コーラ) are left out.</li>' +
